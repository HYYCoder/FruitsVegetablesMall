...
class ShoppingCarFragmentPresenter : ShoppingCarFragmentContract.ShoppingCarFragmentPresenter(){
    ...
    override fun deleteShoppingCarGoods(
        ...
        mManager!!.add(mModel?.deleteShoppingCarGoods(header, param)?.subscribe(object :
    ...
    override fun deleteShoppingCarGood(header: Map<String, String>?, param: String?) {
        mManager!!.add(mModel?.deleteShoppingCarGood(header, param)?.subscribe(object :
            ApiCallBack<Void>(mContext) {
            override fun _onNext(t: Void?, message: String?) {
                mView!!.deleteSuccess()
    ...
    override fun updateShoppingCarCount(
        ...
        mManager!!.add(mModel?.updateShoppingCarCount(header, itemId, body)?.subscribe(object :
            ApiCallBack<Void>(mContext) {
            override fun _onNext(t: Void?, message: String?) {
                mView!!.updateSuccess()
            }
